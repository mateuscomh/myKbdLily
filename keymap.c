...
[_LOWER] = LAYOUT(
  ...
  _______, KC_LEFT,  KC_DOWN, KC_RIGHT, ______, ______,                   _______, _______, _______,_______, _______, _______,
...
[_RAISE] = LAYOUT(
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_END,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
